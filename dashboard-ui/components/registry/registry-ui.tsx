...
// Presentation primitives for the Livestock Registry dashboard. These
// intentionally sit outside the shadcn Card/Chart stack so the registry view can
// match the OpenG2P reference design without restyling every tab.
